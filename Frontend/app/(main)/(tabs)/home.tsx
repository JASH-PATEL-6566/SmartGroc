...
const Home = () => {
  ...
  }, [loadExpiringProducts, loadShoppingLists, loadPreferences]);
  ...
  const handleRecipePress = () => {
    if (recipeSuggestionsEnabled) {
      ...
      // If recipe suggestions are disabled, show a message or redirect to profile
      Alert.alert(
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            ...
            onRefresh={onRefresh}
            colors={["#4CAF50"]} // Green color for Android
            tintColor="#4CAF50" // Green color for iOS
          />
        }
      >
        <TopHeader user={user} />
